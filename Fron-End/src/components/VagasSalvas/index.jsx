...
const VagasSalvas = () => {
    ...
    useEffect(() => {
        const fetchVagasSalvas = async () => {
            ...
            try {
                ...
                const response = await fetch('http://localhost:8080/api/candidatos/me/vagas-salvas', {
                    method: 'GET',
                    headers: {
    ...
    const confirmUnsave = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:8080/api/candidatos/me/vagas-salvas/${vagaToUnsave.id}`, {
                method: 'DELETE',
                headers: {
